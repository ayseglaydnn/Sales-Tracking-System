...
public class AuthController : BaseController
{
    ...
    [HttpPost("Register")]
    public async Task<IActionResult> Register([FromBody] CustomerRegisterDto customerForRegisterDto)
    {
        RegisterCommand registerCommand = new() { CustomerForRegisterDto = customerForRegisterDto, IpAddress = getIpAddress() };
        RegisteredResponse result = await Mediator.Send(registerCommand);
        return Created(uri: "", result.Email);
    }
